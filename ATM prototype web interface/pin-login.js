class PinLogin {
    ...
    _updateValueText() {
        this.el.textDisplay.value = "_".repeat(this.value.length); // dispay on textbox and not on the textbox. if we want to see what's on the textbox: document.querySelector(".pin-login__text"). it will show 1234  ---- in console
...
new PinLogin({
    ...
    loginEndpoint: "login.php", // dashboard.html
